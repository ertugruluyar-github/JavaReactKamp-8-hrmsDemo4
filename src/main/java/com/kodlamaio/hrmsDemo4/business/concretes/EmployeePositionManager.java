...
import com.kodlamaio.hrmsDemo4.dataAccess.abstracts.EmployeePositionDao;
...
public class EmployeePositionManager implements EmployeePositionService {
	...
	public DataResult<List<EmployeePosition>> getAll() {
		return new SuccessDataResult<List<EmployeePosition>>("İş pozisyonları başarıyla listelendi.",
